...
inline void writergb(const std::string name, const std::string desc, const std::string filen, const ColorMap cmap)
{
    ...
    pt.add("swatch.<xmlattr>.description",desc);
    ...
    boost::property_tree::xml_parser::write_xml(filen+".xml", pt, std::locale(),
...
int main()
{
    ...
    writergb("X11 Colors","The set of standard named colors provided by X11","x11colors",
    {
        {"snow",{255,250,250}},
        {"ghost",{248,248,255}},
        {"GhostWhite",{248,248,255}},
